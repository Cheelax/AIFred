...
def build_chat(chat_args: ChatArgs):
    ...
    set_conversation_components(chat_args.conversation_id, retriever_name, llm_name, memory_name)
    condense_question_llm= ChatOpenAI(streaming=False)

    trace=langfuse.trace(CreateTrace(id=chat_args.conversation_id, metadata=chat_args.metadatas))
